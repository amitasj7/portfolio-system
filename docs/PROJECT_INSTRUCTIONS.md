...
- Accidental
- Exploratory
- Unrelated to current feature
- Learning or testing

MUST be done in a sandbox branch, e.g.:
...
Sandbox branches:
- Are never merged into develop
- Can be deleted anytime
- Do not affect production


commit type: git commit -m "wip: experimental or unrelated work"
Prefix wip: = work in progress (signals “not production”).

🔒 Final golden rule (remember this)
If you’re not 100% sure it’s production work → use a sandbox branch.